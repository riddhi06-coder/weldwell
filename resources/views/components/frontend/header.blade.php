...
// Offcanvas sidebar — company info + socials from the contact details.
$headerContact = \App\Models\Contact::where('is_active', true)->with('socials')->first();
...
<div class="tp-offcanvas-area">
    <div class="tp-offcanvas">
        ...
        <div class="tp-offcanvas-content d-none d-xl-block">
            <h3 class="tp-offcanvas-title">{{ $headerContact?->sidebar_company_name }}</h3>
            <p>
                {!! nl2br(e($headerContact?->sidebar_desc)) !!}
            </p>
        </div>
        ...
        <div class="tp-offcanvas-contact">
            ...
            <ul>
                <li>
                    <a href="tel:{{ $headerContact?->sidebar_contact_no }}">{{ $headerContact?->sidebar_contact_no }}</a>
                </li>
                <li>
                    <a href="mailto:{{ $headerContact?->sidebar_email }}">{{ $headerContact?->sidebar_email }}</a>
                </li>
                <li>
                    <a href="{{ $headerContact?->sidebar_website ?: '#' }}" target="_blank">
                        {{ $headerContact?->sidebar_website }}
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="tp-offcanvas-social">
            ...
            <ul>
                @foreach(($headerContact?->socials ?? collect()) as $social)
                <li>
                    <a href="{{ $social->url ?: '#' }}" target="_blank">
                        <i class="{{ \App\Models\ContactSocial::PLATFORMS[$social->platform]['icon'] ?? 'fab fa-link' }}"></i>
                    </a>
                </li>
                @endforeach
            </ul>
...
<header>
    ...
    <div id="header-sticky"
        class="tp-header-area pre-header al-header-seo tp-header-it-wrap sticky-white-bg tp-header-blur header-transparent tp-header-lg-spacing">
        <div class="container-fluid container-1824">
            <div class="tp-header-ai-bg">
                <div class="row align-items-center">
                    ...
                    <div class="col-xxl-7 col-xl-7 d-none d-xl-block">
                        <div
                            class="tp-main-menu tp-main-menu-ai tp-header-dropdown dropdown-white-bg d-flex justify-content-center">
