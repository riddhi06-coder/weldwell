    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            <main>
                ...
                <div id="down" class="tp-contact-us-form-ptb pre-header pb-120">
                    <div class="container container-1750 containers">
                        <div class="tp-contact-us-form-wrapper">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="tp-contact-us-map p-relative">
                                        <iframe src="{{ $contact?->iframe_url }}" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="tp-contact-us-wrap">
                                        <h4 class="tp-contact-us-title mb-25">Send a Message</h4>
                                        <form id="contact-form" action="assets/mail-contact-us.php" method="POST">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="tp-postbox-details-input mb-20">
                                                        <label class="fs-18 tp-ff-p tp-text-common-black mb-10">
                                                            Subject*
                                                        </label>

                                                        <select class="tp-input tp-select" name="subject" required>
                            ...
                            <div class="col-xl-10">
                                <div class="cn-contactform-support-bg d-flex align-items-center justify-content-center">
                                    <div class="cn-contactform-support-text text-center">
                                        <span>{{ $contact?->address_heading }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="tp-contact-us-info-area pb-120">
                    <div class="container container-1230">
                        <div class="row justify-content-center">
                            ...
                            @foreach(($contact?->offices ?? collect()) as $office)
                            <div class="col-xl-4 col-lg-6 col-md-6 mb-30">
                                <div class="tp-contact-us-content text-center{{ $loop->iteration % 2 == 0 ? ' mt-60' : '' }}" data-speed="{{ $loop->iteration % 2 == 0 ? '.9' : '1.2' }}">

                                    <div class="tp-contact-us-thumb d-flex justify-content-center">
                                        <img src="{{ $office->image ? asset('contact/offices/' . $office->image) : asset('assets/images/contact/head-oofice.webp') }}"
                                    ...
                                    <div class="tp-contact-us-bottom">
                                        <div class="tp-contact-us-info-details">
                                            ...
                                            <h4 class="tp-contact-us-info-title">
                                                {{ $office->office_name }}
                                            </h4>
                                        ...
                                        @if($office->map_url)
                                        <div class="tp-rounded-btn-wrap tp-about-wd-btn mt-30 tp_fade_anim"
                                            data-delay=".5"
                                            data-fade-from="top"
                                            data-ease="bounce">

                                            <div class="btn_wrapper d-inline-block">
                                                <a href="{{ $office->map_url }}"
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    class="tp-btn-rounded btn-item">
