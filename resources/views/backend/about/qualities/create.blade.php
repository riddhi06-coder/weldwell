    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add Core Qualities</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manage-about-qualities.index') }}">Core Qualities</a></li>
                            <li class="breadcrumb-item active">Add Core Qualities</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="f-m-light mt-1">Header heading &amp; image, the core values list and the more-info section.</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-4 custom-input" action="{{ route('manage-about-qualities.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-3">
                                            @include('backend.about.qualities._values', [
                                                'values' => old('values', [['value_name' => '', 'description' => '']]),
                                            ])
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <small class="text-muted">JPG, PNG or WebP · Max 2 MB.</small>
                                                <div class="mt-2">
                                                    <img id="preview_background_image" src="#" alt="Background"
                                                        style="height:70px;width:auto;border-radius:6px;border:1px solid #eee;display:none;">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" id="more_info_desc" name="more_info_desc" rows="4" placeholder="A short description shown over the video image.">{{ old('more_info_desc') }}</textarea>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" id="statement" name="statement" rows="2" placeholder="A short statement">{{ old('statement') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
