    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Edit Customers Served</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manage-about-customer.index') }}">Customers Served</a></li>
                            <li class="breadcrumb-item active">Edit Customers Served</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="f-m-light mt-1">Update the heading, title, features list and highlights list.</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-4 custom-input" action="{{ route('manage-about-customer.update', $customer->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="heading" type="text" name="heading"
                                                    value="{{ old('heading', $customer->heading) }}" placeholder="e.g. Customers We Serve">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="title">Title</label>
                                                <input class="form-control" id="title" type="text" name="title"
                                                    value="{{ old('title', $customer->title) }}" placeholder="e.g. Trusted across industries">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-3">
                                            @include('backend.about.customers._repeater', [
                                                ...
                                                'rows'        => old('features', $customer->features->pluck('feature_name')->all() ?: ['']),
                                            ])
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-3">
                                            @include('backend.about.customers._repeater', [
                                                ...
                                                'rows'        => old('highlights', $customer->highlights->pluck('highlight_name')->all() ?: ['']),
                                            ])
                                        </div>
                                    </div>
                                </div>
