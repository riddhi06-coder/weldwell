                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="f-m-light mt-1">Build the full detail page for a product category.</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-4 custom-input" action="{{ route('manage-product-category-details.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mt-2"><img id="preview_banner_image" src="#" alt="Banner" style="height:60px;width:auto;border-radius:6px;border:1px solid #eee;display:none;"></div>
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label" for="banner_description">Banner Description <span class="txt-danger">*</span></label>
                                                <textarea class="form-control" id="banner_description" name="banner_description" rows="2" placeholder="Short banner text">{{ old('banner_description') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <small class="text-muted">JPG, PNG or WebP · Max 2 MB.</small>
                                                <div class="mt-2"><img id="preview_section_image" src="#" alt="Section" style="height:60px;width:auto;border-radius:6px;border:1px solid #eee;display:none;"></div>
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label" for="section_description">Section Description <span class="txt-danger">*</span></label>
                                                <textarea class="form-control ckeditor-init" id="section_description" name="section_description" rows="4">{{ old('section_description') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="product_range_title" type="text" name="product_range_title" value="{{ old('product_range_title') }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="product_range_heading">Section Heading <span class="txt-danger">*</span></label>
                                                <input class="form-control" id="product_range_heading" type="text" name="product_range_heading" value="{{ old('product_range_heading') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="knowledge_title" type="text" name="knowledge_title" value="{{ old('knowledge_title') }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="knowledge_heading">Section Heading <span class="txt-danger">*</span></label>
                                                <input class="form-control" id="knowledge_heading" type="text" name="knowledge_heading" value="{{ old('knowledge_heading') }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="knowledge_background_image">Background Image <span class="txt-danger">*</span></label>
                                                ...
                                                <small class="text-muted">JPG, PNG or WebP · Max 2 MB.</small>
                                                <div class="mt-2"><img id="preview_knowledge_background_image" src="#" alt="Background" style="height:60px;width:auto;border-radius:6px;border:1px solid #eee;display:none;"></div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <small class="text-muted">PDF or Word · Max 5 MB. Optional.</small>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="knowledge_map_url" type="text" name="knowledge_map_url" value="{{ old('knowledge_map_url') }}" placeholder="https://maps.google.com/...">
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label" for="knowledge_description">Description <span class="txt-danger">*</span></label>
                                                <textarea class="form-control ckeditor-init" id="knowledge_description" name="knowledge_description" rows="4">{{ old('knowledge_description') }}</textarea>
                                            </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered align-middle mb-0">
                                                        ...
                                                        <tbody id="featuresBody">
                                                            @php $featureNumbers = old('feature_number', ['']); @endphp
                                                            @foreach($featureNumbers as $i => $num)
                                                            <tr class="feature-row">
                                                                <td class="row-index text-center"></td>
                                                                <td><input class="form-control" type="text" name="feature_number[]" value="{{ $num }}" placeholder="e.g. 25+ , 90%"></td>
                                                                <td><input class="form-control" type="text" name="feature_description[]" value="{{ old('feature_description.'.$i) }}" placeholder="Description"></td>
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="industries_title" type="text" name="industries_title" value="{{ old('industries_title') }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="industries_heading">Section Heading <span class="txt-danger">*</span></label>
                                                <input class="form-control" id="industries_heading" type="text" name="industries_heading" value="{{ old('industries_heading') }}">
                                            </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered align-middle mb-0">
                                                        ...
                                                        <tbody id="industriesBody">
                                                            @foreach(old('industry_name', ['']) as $name)
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="media_title" type="text" name="media_title" value="{{ old('media_title') }}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label" for="media_heading">Section Heading <span class="txt-danger">*</span></label>
                                                <input class="form-control" id="media_heading" type="text" name="media_heading" value="{{ old('media_heading') }}">
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label" for="media_description">Description <span class="txt-danger">*</span></label>
                                                <textarea class="form-control ckeditor-init" id="media_description" name="media_description" rows="4">{{ old('media_description') }}</textarea>
                                            </div>
                                            <div class="col-12">
                                                <label class="form-label" for="media_youtube_url">YouTube Iframe URL <span class="txt-danger">*</span></label>
                                                <input class="form-control" id="media_youtube_url" type="text" name="media_youtube_url" value="{{ old('media_youtube_url') }}" placeholder="https://www.youtube.com/embed/...">
                                            </div>
                                        </div>
                                    </div>
                                </div>
