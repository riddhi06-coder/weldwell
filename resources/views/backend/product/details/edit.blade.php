                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="f-m-light mt-1">Update the product category and name — the slug is regenerated automatically.</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-product-category-details.update', $detail->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="name" type="text" name="name"
                                        value="{{ old('name', $detail->name) }}" placeholder="e.g. MIG Welding Machine, TIG Torch">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mt-2">
                                        <img id="preview_image" src="{{ $detail->image ? asset('product/details/' . $detail->image) : '#' }}" alt="Image"
                                            style="height:60px;width:auto;border-radius:6px;border:1px solid #eee;{{ $detail->image ? '' : 'display:none;' }}">
                                    </div>
                                </div>
