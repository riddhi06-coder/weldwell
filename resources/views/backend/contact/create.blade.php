                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="heading" type="text" name="heading"
                                                    value="{{ old('heading') }}" placeholder="e.g. Get in Touch">
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="address_heading" type="text" name="address_heading"
                                                    value="{{ old('address_heading') }}" placeholder="e.g. Our Address">
                                            </div>
                                            <div class="col-md-12">
                                                <label class="form-label" for="intro_message">Intro Message <span class="txt-danger">*</span></label>
                                                <textarea class="form-control" id="intro_message" name="intro_message" rows="3" placeholder="Short intro message">{{ old('intro_message') }}</textarea>
                                            </div>
                                            <div class="col-md-12">
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="sidebar_company_name" type="text" name="sidebar_company_name"
                                                    value="{{ old('sidebar_company_name') }}" placeholder="e.g. Weldwell Speciality Pvt. Ltd.">
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="sidebar_contact_no" type="text" name="sidebar_contact_no"
                                                    value="{{ old('sidebar_contact_no') }}" placeholder="e.g. +91 22 6646 2000">
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="sidebar_email" type="email" name="sidebar_email"
                                                    value="{{ old('sidebar_email') }}" placeholder="e.g. info@weldwell.com">
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="sidebar_website" type="text" name="sidebar_website"
                                                    value="{{ old('sidebar_website') }}" placeholder="e.g. www.weldwell.com">
                                            </div>
                                            <div class="col-md-12">
                                                <label class="form-label" for="sidebar_desc">Description <span class="txt-danger">*</span></label>
                                                <textarea class="form-control" id="sidebar_desc" name="sidebar_desc" rows="3" placeholder="Short description">{{ old('sidebar_desc') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
