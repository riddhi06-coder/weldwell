    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Edit Knowledge Spectrum</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manage-home-knowledge-spectrum.index') }}">Knowledge Spectrum</a></li>
                            <li class="breadcrumb-item active">Edit Knowledge Spectrum</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="f-m-light mt-1">Update the title, heading and background image (JPG, PNG or WebP, max 2&nbsp;MB).</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-home-knowledge-spectrum.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="title" type="text" name="title"
                                        value="{{ old('title', $item->title) }}" placeholder="e.g. Knowledge Spectrum">
                                </div>
                                ...
                                <div class="col-md-6" style="margin-top:2rem;">
                                    ...
                                    <div class="mt-2">
                                        <img id="preview_background_image"
                                            src="{{ $item->background_image ? asset('home/knowledge/' . $item->background_image) : '#' }}"
                                            alt="Background image"
                                            style="height:80px;width:auto;border-radius:6px;border:1px solid #eee;{{ $item->background_image ? '' : 'display:none;' }}">
                                    </div>
                                </div>
