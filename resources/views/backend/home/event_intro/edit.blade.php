    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Edit Event Intro</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manage-home-events.index') }}">Event Intro</a></li>
                            <li class="breadcrumb-item active">Edit Event Intro</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="f-m-light mt-1">Update the heading and title.</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-home-events.update', $item->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" id="heading" type="text" name="heading"
                                        value="{{ old('heading', $item->heading) }}" placeholder="e.g. Upcoming Events">
                                </div>

                                <div class="col-md-12">
                                    <label class="form-label" for="title">Title</label>
                                    <textarea class="form-control ckeditor-init" id="title" name="title" rows="4">{{ old('title', $item->title) }}</textarea>
                                </div>
