    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add About Details</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="f-m-light mt-1">Add the heading, title, images (max 2&nbsp;MB each), intro, description and experience details.</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-home-about.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="heading" type="text" name="heading"
                                        value="{{ old('heading') }}" placeholder="e.g. About Us">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="experience_title" type="text" name="experience_title"
                                        value="{{ old('experience_title') }}" placeholder="e.g. Years of Experience">
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label" for="experience">Experience</label>
                                    <input class="form-control" id="experience" type="text" name="experience"
                                        value="{{ old('experience') }}" placeholder="e.g. 25+" inputmode="numeric">
                                ...
                                @include('backend.home.about._images', ['about' => null])

                                <div class="col-md-12">
                                    <label class="form-label" for="small_intro">Small Intro</label>
                                    <textarea class="form-control ckeditor-init" id="small_intro" name="small_intro" rows="3">{{ old('small_intro') }}</textarea>
                                </div>

                                <div class="col-md-12">
                                    <label class="form-label" for="description">Description</label>
                                    <textarea class="form-control ckeditor-init" id="description" name="description" rows="5">{{ old('description') }}</textarea>
                                </div>
