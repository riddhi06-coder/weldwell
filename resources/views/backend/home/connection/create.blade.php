    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add Connection</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manage-home-connection.index') }}">Connection</a></li>
                            <li class="breadcrumb-item active">Add Connection</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="f-m-light mt-1">Add the title, heading and contact email.</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-3 custom-input" action="{{ route('manage-home-connection.store') }}" method="POST">
                                @csrf

                                <div class="col-md-6">
                                    <label class="form-label" for="title">Title <span class="txt-danger">*</span></label>
                                    <input class="form-control" id="title" type="text" name="title"
                                        value="{{ old('title') }}" placeholder="e.g. Let's Connect">
                                </div>
