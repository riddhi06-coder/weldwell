                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active">Products Introduction</li>
                                </ol>
                            </nav>
                            @if(auth()->user()->hasPermission('product-intros.create') && $intros->isEmpty())
                        <a href="{{ route('manage-product-intro.create') }}" class="btn btn-primary px-5 radius-30">+ Add Product Intro</a>
                    @endif
                        </div>
