    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6"><h4>Add Job Listing</h4></div>
                    <div class="col-6">
                        <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <p class="f-m-light mt-1">Add an open position for the careers page.</p>
                        </div>
                        <div class="card-body">
                            ...
                            <form class="row g-4 custom-input" action="{{ route('manage-job-listing.store') }}" method="POST">
                                @csrf
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-4">
                                                ...
                                                <input class="form-control" id="role_name" type="text" name="role_name"
                                                    value="{{ old('role_name') }}" placeholder="e.g. Sales Engineer">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label" for="location">Location <span class="txt-danger">*</span></label>
                                                <input class="form-control" id="location" type="text" name="location"
                                                    value="{{ old('location') }}" placeholder="e.g. Mumbai, India">
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control ckeditor-init" id="description" name="description" rows="6">{{ old('description') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
