...
<body>
    ...
    @php
        $benefitRows = old('benefit')
            ? collect(old('benefit'))->map(fn ($b, $i) => ['benefit' => $b, 'description' => old('benefit_description.' . $i)])->all()
            : ($detail->benefits->map(fn ($b) => ['benefit' => $b->benefit, 'description' => $b->description])->all() ?: [['benefit' => '', 'description' => '']]);
    @endphp
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-4 custom-input" action="{{ route('manage-career-page-details.update', $detail->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control" id="banner_heading" type="text" name="banner_heading"
                                                    value="{{ old('banner_heading', $detail->banner_heading) }}" placeholder="e.g. Build Your Career With Weldwell">
                                            </div>
                                            <div class="col-md-12">
                                                <label class="form-label" for="description">Description <span class="txt-danger">*</span></label>
                                                <textarea class="form-control ckeditor-init" id="description" name="description" rows="4">{{ old('description', $detail->description) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-bordered align-middle mb-0">
                                                ...
                                                <tbody id="benefitsBody">
                                                    ...
                                                    <tr class="benefit-row">
                                                        ...
                                                        <td><input class="form-control" type="text" name="benefit[]" value="{{ $row['benefit'] }}" placeholder="e.g. Health Insurance"></td>
                                                        <td><textarea class="form-control" name="benefit_description[]" rows="2" placeholder="Description">{{ $row['description'] }}</textarea></td>
                                    ...
                                    <div class="border rounded p-3">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input class="form-control" id="career_heading" type="text" name="career_heading" value="{{ old('career_heading', $detail->career_heading) }}">
                                            </div>
                                            <div class="col-md-4">
                                                <label class="form-label" for="title">Title <span class="txt-danger">*</span></label>
                                                <input class="form-control" id="title" type="text" name="title" value="{{ old('title', $detail->title) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
