        ...
        <div class="container-fluid py-4">
            ...
            @php
                ...
                $cards = [
                    ...
                    ['label' => 'Brand Categories', 'count' => $stats['brandCategories'], 'perm' => 'brand-categories.view',     'route' => route('manage-brand-category.index'),   'icon' => 'tag',          'c' => '#e5011c', 't' => '#FCE7EA'],
                    ['label' => 'Sub Categories',   'count' => $stats['subCategories'],   'perm' => 'brand-subcategories.view',  'route' => route('manage-brand-list.index'),'icon' => 'bookmark',     'c' => '#ea580c', 't' => '#FCEDE3'],
